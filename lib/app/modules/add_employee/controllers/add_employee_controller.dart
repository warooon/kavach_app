...
import 'package:kavachApp/app/widgets/dialog/custom_alert_dialog.dart';
  ...
  Future<void> addEmployee() async {
    if (idC.text.isNotEmpty &&
      ...
      CustomAlertDialog.confirmAdmin(
        ...
        message: 'Confirm Administrator/nEnter Password',
        onCancel: () {
      ...
      isLoading.value = false;
      CustomToast.errorToast('Error', 'Form Incomplete');
    }
  }
